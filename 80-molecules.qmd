...
Table: Géométries VSEPR. {#tbl-tab-vsepr}
...
```{r, child=c('exe/molecules/130.Rmd')}
```
...
```{r fig-dipole-0,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Variation de l'intensité du dipôle"}
...
```{r fig-dipole-1,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Dipôle résultant de l'addition des polarités des liaisons"}
...
```{r fig-dipole-3,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Comportement des molécules polaires"}
...
```{r fig-dipole-4,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Molécules non polaires"}
knitr::include_graphics(c("images/dipole-4.png"))
```

```{r, child=c('exe/molecules/140.Rmd')}
```
...
```{r fig-forces-london,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Apparition des forces de dispersion"}
...
```{r fig-dipole-dipole,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Molécules polaires et interaction dipôle-dipôle."}
...
```{r fig-eau-liaison-hydrogene,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="La liaison hydrogène entre les molécules d'eau"}
#| layout-ncol: 3
...
```{r fig-dna,echo=FALSE,out.width="100%",fig.show="hold",fig.align="center",fig.cap="Paires de bases, liaisons hydrogène et ADN."}
...
Table: Comparatif des forces intermoléculaires. {#tbl-comparatif-intermoleculaires}

\newpage

```{r fig-forces-intermoleculaires-resume,echo=FALSE,out.width="100%",fig.show="hold",fig.align="center",fig.cap="Résumé des forces intermoléculaires"}
knitr::include_graphics(c("images/forces-intermoleculaires-resume.png"))
```

```{r, child=c('exe/molecules/150.Rmd')}
```
...
```{r, child=c('exe/molecules/160.Rmd')}
```

```{r, child=c('exe/molecules/170.Rmd')}
```

\newpage

```{r, child=c('exe/molecules/180.Rmd')}
```

```{r, child=c('exe/molecules/190.Rmd')}
```
