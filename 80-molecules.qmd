...
{{< include exe/molecules/10.qmd >}}

{{< include exe/molecules/130.qmd >}}
...
![Variation de l'intensité du dipôle](images/dipole-0.png){#fig-dipole-0 width="60%"}
...
![Dipôle résultant de l'addition des polarités des liaisons](images/dipole-1.png){#fig-dipole-1 width="60%"}
...
![Comportement des molécules polaires](images/dipole-3.png){#fig-dipole-3 width="60%"}
...
![Molécules non polaires](images/dipole-4.png){#fig-dipole-4 width="50%"}

{{< include exe/molecules/140.qmd >}}
...
![Apparition des forces de dispersion](images/forces-london.png){#fig-forces-london width="67%"}
...
![Molécules polaires et interaction dipôle-dipôle.](images/dipole-dipole.png){#fig-dipole-dipole width="67%"}
...
::: {#fig-eau-liaison-hydrogene layout-ncol=3}
![](images/ice-0.png)

![](images/ice-tetra.png)

![](images/ice.png)

La liaison hydrogène entre les molécules d'eau
:::
...
![Paires de bases, liaisons hydrogène et ADN.](images/dna.png){#fig-dna width="100%"}
...
![Résumé des forces intermoléculaires](images/forces-intermoleculaires-resume.png){#fig-forces-intermoleculaires-resume width="100%"}

{{< include exe/molecules/150.qmd >}}
...
{{< include exe/molecules/160.qmd >}}

{{< include exe/molecules/170.qmd >}}

\newpage

{{< include exe/molecules/180.qmd >}}

{{< include exe/molecules/190.qmd >}}
