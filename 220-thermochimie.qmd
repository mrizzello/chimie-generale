...
```{r, child=c('exe/thermochimie/05.Rmd')}
```
...
```{r fig-enthalpie-2,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Diagramme d'enthalpie de la combustion du méthane."}
...
```{r fig-enthalpie-3,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Diagramme d'enthalpie de la combustion du propane."}
knitr::include_graphics(c("images/Enthalpie-3.png"))
```

```{r, child=c('exe/thermochimie/100.Rmd')}
```
...
```{r, child=c('exe/thermochimie/110.Rmd')}
```

```{r, child=c('exe/thermochimie/120.Rmd')}
```

```{r, child=c('exe/thermochimie/130.Rmd')}
```
