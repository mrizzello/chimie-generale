...
{{< include exe/thermochimie/05.qmd >}}
...
\qquad
\begin{split}
q & \text{: quantité de chaleur}\ \text{ J} \\
m & \text{: masse}\ \text{ g} \\
C_p & \text{: capacité thermique}\ \mathrm{J/(K \cdot g)} \\
\Delta T & \text{: différence de température}\ \text{ K}
\end{split}
$$

{{< include exe/thermochimie/10.qmd >}}

\newpage

{{< include exe/thermochimie/20.qmd >}}

{{< include exe/thermochimie/30.qmd >}}
...
$$
\begin{split}
\ce{N#N -> N + N} \quad \Delta H = +946\ \text{ kJ/mol} \\ 
\ce{Cl-Cl -> Cl + Cl} \quad \Delta H = +246\ \text{ kJ/mol}
\end{split}
$$
...
Table: Énergies de liaison moyennes de liaisons communes {#tbl-tab-energie-liaison}
...
\begin{split}
  \text{Réactifs}& \\[0.1em]
  (\ce{C-H}) \times 4 = -413 \cdot 4 &= -1652\ \text{ kJ} \\[0.1em]
  (\ce{O=O}) \times 2 = -498 \cdot 2 &= -996\ \text{ kJ} \\[0.1em]
  \hline\\[-1.2em]
  total &= -2648\ \text{ kJ}
\end{split}
\qquad
\begin{split}
  \text{Produits}& \\
  (\ce{C=O}) \times 2 = -799 \cdot 2 &= -1598\ \text{ kJ} \\[0.1em]
  (\ce{H-O}) \times 4 = -467 \cdot 4 &= -1868\ \text{ kJ} \\[0.1em]
  \hline\\[-1.2em]
  total &= -3466\ \text{ kJ}
\end{split}
$$
...
{{< include exe/thermochimie/50.qmd >}}

{{< include exe/thermochimie/60.qmd >}}

{{< include exe/thermochimie/70.qmd >}}
...
{{< include exe/thermochimie/90.qmd >}}
...
![Diagramme d'enthalpie de la combustion du méthane.](images/Enthalpie-2.png){#fig-enthalpie-2 width="67%"}
\newpage
...
\Delta H^{0} &= \Delta H_1 + \Delta H_2 + \Delta H_3 \\
 ...
 &= - (−104.6\ \text{ kJ}) + 3 \cdot (−393.5\ \text{ kJ}) + 4 \cdot (−285.8\ \text{ kJ}) \\
 &= -2219\ \text{ kJ} \\
\end{split}
$$

![Diagramme d'enthalpie de la combustion du propane.](images/Enthalpie-3.png){#fig-enthalpie-3 width="67%"}

{{< include exe/thermochimie/100.qmd >}}
...
{{< include exe/thermochimie/80.qmd >}}

{{< include exe/thermochimie/110.qmd >}}

{{< include exe/thermochimie/120.qmd >}}

{{< include exe/thermochimie/130.qmd >}}
