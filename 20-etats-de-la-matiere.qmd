...
![Les trois niveaux de représentation de la chimie](images/Johnstone.png){#fig-Johnstone width="50%"}
...
![Les différents états de la matière du point de vue macroscopique et submicroscopique](images/solide-liquide-gaz.png){#fig-solide-liquide-gaz width="50%"}
...
![Équilibre entre forces intermoléculaires et énergie thermique](images/mvt-thermique.png){#fig-mvt-thermique width="67%"}
...
{{< include exe/etats-matiere/05.qmd >}}
...
![Les noms des changements d'état](images/chgt-etats.png){#fig-chgt-etats width="45%"}

\newpage

{{< include exe/etats-matiere/10.qmd >}}

{{< include exe/etats-matiere/20.qmd >}}

\newpage

## Les courbes de changement d'état

![Courbe de chauffage de l'eau](images/courbe-chgt-etat.png){#fig-courbe-chgt-etat width="40%"}
...
{{< include exe/etats-matiere/25.qmd >}}
...
![Diagramme de phases de l'eau et du CO~2~ (Les échelles ne sont pas régulières)](images/diagramme-phases-eau-CO2.png){#fig-diagramme-phases-eau-CO2 width="100%"}

{{< include exe/etats-matiere/30.qmd >}}
...
![Tension superficielle](images/tension-surface.png){#fig-tension-surface width="33%"}
...
![La capillarité](images/capillarity.png){#fig-capillarity width="67%"}

\newpage

{{< include exe/etats-matiere/32.qmd >}}
...
![Solide amorphe (Verre) - Solide cristallin (Quartz)](images/amorphous.png){#fig-amorphous width="45%"}
...
![3 mailles de réseaux cristallins classiques (CFC: cubique à face centrées, CC: cubique centré, HC: hexagonal compact)](images/metaux.png){#fig-metaux width="67%"}
...
![Trois formes allotropiques du carbone (graphite, diamant, fullerène)](images/allotropes.png){#fig-allotropes width="45%"}

{{< include exe/etats-matiere/34.qmd >}}
...
{{< include exe/etats-matiere/40.qmd >}}

\newpage

{{< include exe/etats-matiere/50.qmd >}}

{{< include exe/etats-matiere/60.qmd >}}

\newpage

{{< include exe/etats-matiere/70.qmd >}}

\newpage

{{< include exe/etats-matiere/80.qmd >}}

\newpage

{{< include exe/etats-matiere/90.qmd >}}

{{< include exe/etats-matiere/100.qmd >}}
