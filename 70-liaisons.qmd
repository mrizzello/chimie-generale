...
```{r fig-methanol-formulas,echo=FALSE,out.width="100%",fig.show='hold',fig.align='center',fig.cap="La molécule de méthanol."}
...
```{r fig-deltaE,echo=FALSE,out.width="85%",fig.show="hold",fig.align="center",fig.cap="Intervalles de $\\Delta$E pour déterminer le type de liaison"}
...
```{r fig-NaCl-diagram,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Liaison ionique entre chlore et sodium"}
...
```{r fig-CaF2-diagram,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Liaison ionique entre calcium et fluor"}
...
```{r fig-NaClCaF2,echo=FALSE,out.width="25%",,fig.show='hold',fig.align='center',fig.cap="Réseaux ioniques formés par $NaCl$ et $CaF_2$."}
#| layout-ncol: 2
...
```{r fig-H2-bond,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Formation de $H_2$"}
...
```{r fig-liaisons-multiples,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Exemples de liaisons covalentes simples, doubles et triples"}
...
```{r fig-covalences-coordination,echo=FALSE,out.width="85%",fig.show="hold",fig.align="center",fig.cap="Exemples de covalences de coordination."}
...
```{r fig-metallic-bonding,echo=FALSE,out.width="40%",fig.show="hold",fig.align="center",fig.cap="Modèle de la liaison métallique"}
...
```{r, child=c('exe/liaisons/100.Rmd')}
```

```{r, child=c('exe/liaisons/110.Rmd')}
```

\newpage

```{r, child=c('exe/liaisons/120.Rmd')}
```

```{r, child=c('exe/liaisons/130.Rmd')}
```
