...
![Taille et structure de l'atome](images/ordre-grandeur-atome.png){#fig-ordre-grandeur-atome width="33%"}
...
Table: Les particules subatomiques. {#tbl-particules-subatomiques}
...
{{< include exe/atome/05.qmd >}}

\newpage

{{< include exe/atome/10.qmd >}}

{{< include exe/atome/20.qmd >}}
...
![Table des isotopes simplifiée](images/isotopes-table.png){#fig-isotopes-table width="80%"}

{{< include exe/atome/30.qmd >}}
...
Table: Unités de comptage. {#tbl-unites-de-comptage}

Une mole d'atomes, une mole de molécules, ou une mole de quoi que ce soit contiennent toutes $6.022\cdot10^{23}$ objets.

{{< include exe/atome/70.qmd >}}

{{< include exe/atome/80.qmd >}}

\newpage

{{< include exe/atome/90.qmd >}}

## La masse molaire atomique

![Relation entre unité de masse atomique et masse molaire.](images/uma-masse-molaire.png){#fig-uma-masse-molaire width="67%"}
...
{{< include exe/atome/110.qmd >}}

{{< include exe/atome/120.qmd >}}

\newpage

{{< include exe/atome/130.qmd >}}

{{< include exe/atome/140.qmd >}}

{{< include exe/atome/150.qmd >}}

\newpage

{{< include exe/atome/160.qmd >}}

{{< include exe/atome/170.qmd >}}

{{< include exe/atome/180.qmd >}}

\newpage

{{< include exe/atome/190.qmd >}}

{{< include exe/atome/200.qmd >}}

\newpage

{{< include exe/atome/210.qmd >}}

{{< include exe/atome/220.qmd >}}

\newpage

{{< include exe/atome/230.qmd >}}

{{< include exe/atome/240.qmd >}}
