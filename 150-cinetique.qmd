...
![Variation des quantités de substances en fonction du temps](images/vitesse-reaction-1-a.png){#fig-vitesse-reaction-1-a width="45%"}
...
{{< include exe/cinetique/10.qmd >}}

{{< include exe/cinetique/20.qmd >}}
...
![Détermination graphique de la vitesse instantanée](images/vitesse-reaction-1-b.png){#fig-vitesse-reaction-1-b width="45%"}

La vitesse instantanée mesurée au début de la réaction (t = 0) est appelée **vitesse initiale**.

{{< include exe/cinetique/25.qmd >}}
...
![Profil énergétique et énergie d'activation](images/chaleur-Ea-1.png){#fig-chaleur-Ea-1 width="33%"}
...
![Hydrogénation de liaisons doubles carbone-carbone](images/catalyse-H2.png){#fig-catalyse-H2 width="50%"}
...
{{< include exe/cinetique/50.qmd >}}

{{< include exe/cinetique/60.qmd >}}

{{< include exe/cinetique/70.qmd >}}
