...
$$
\text{eau à l'état liquide }\ \xrightarrow{\text{évaporation}}\ \text{eau à l'état gazeux}
$$
...
$$
\text{papier}\ +\ \text{oxygène} \ \xrightarrow{\text{combustion}} \ \text{dioxyde de carbone} + \text{eau}
$$
