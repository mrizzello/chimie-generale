...
$$
\begin{split}
    \ce{CH4(g) + 2O2(g) -> CO2(g) + 2H2O(l)} &\qquad \Delta H^{o} = -890.4 \text{ kJ/mol} \\
    \ce{H^+(aq) + OH^-(aq) -> H2O(l)} &\qquad \Delta H^{o} = -56.2 \text{ kJ/mol}
\end{split}
$$
...
Table: Exemples de transformations spontanées et non spontanées. {#tbl-spontane-non-spontane-exemples}
...
{{< include exe/thermodynamique/10.qmd >}}
...
![Deuxième loi de la thermodynamique](images/cards-castle.png){#fig-cards-castle width="40%"}
...
![Entropies du dihydrogène et du chlorométhane en fonction de la température.](images/entropie-graph.png){#fig-entropie-graph width="90%"}

{{< include exe/thermodynamique/05.qmd >}}
...
{{< include exe/thermodynamique/20.qmd >}}
...
{{< include exe/thermodynamique/30.qmd >}}
...
Table: Spontanéité d'une réaction selon le signe de $\Delta G$. {#tbl-spontaneitedHdS}

{{< include exe/thermodynamique/55.qmd >}}
...
{{< include exe/thermodynamique/60.qmd >}}
...
{{< include exe/thermodynamique/80.qmd >}}
...
Table: Relation entre constante d'équilibre (K) et énergie libre standard de réaction ($\Delta G^o$). {#tbl-spontaneiteDGK}
...
![Énergie libre standard et transformation spontanée](images/dG-profile.png){#fig-dG-profile width="100%"}

\newpage

{{< include exe/thermodynamique/70.qmd >}}
...
{{< include exe/thermodynamique/40.qmd >}}

\newpage

{{< include exe/thermodynamique/50.qmd >}}

{{< include exe/thermodynamique/90.qmd >}}

\newpage

{{< include exe/thermodynamique/100.qmd >}}
