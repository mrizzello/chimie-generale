...
```{r, child=c('exe/nomenclature/05.Rmd')}
```
...
```{r, child=c('exe/nomenclature/15.Rmd')}
```
...
```{r, child=c('exe/nomenclature/25.Rmd')}
```
...
```{r, child=c('exe/nomenclature/70.Rmd')}
```

```{r, child=c('exe/nomenclature/80.Rmd')}
```

\newpage

```{r, child=c('exe/nomenclature/90.Rmd')}
```

```{r, child=c('exe/nomenclature/100.Rmd')}
```
