...
![Chronologie du cosmos](images/timeline-cosmos.png){#fig-timeline-cosmos width="80%"}

{{< include exe/historique/10.qmd >}}

{{< include exe/historique/12.qmd >}}
...
![Schéma du tube cathodique de Thomson](images/exp-thomson.png){#fig-exp-thomson width="40%"}
...
![Bombardement de la feuille d'or](images/exp-rutherford.png){#fig-exp-rutherford width="40%"}
...
![Comparaison des modèles de Thomson et de Rutherford](images/exp-thomson-rutherford.png){#fig-exp-thomson-rutherford width="40%"}
...
![Le modèle de Schrödinger](images/modeles-atomiques-cloud.png){#fig-modeles-atomiques-cloud width="25%"}
...
![Évolution du modèle atomique](images/modeles-atomiques-evol-3.png){#fig-modeles-atomiques-evol-3 width="85%"}
...
{{< include exe/historique/20.qmd >}}

{{< include exe/historique/22.qmd >}}
...
![Tailles relatives approximatives en mètres](images/ordre-grandeur-ex.png){#fig-ordre-grandeur-ex width="100%"}
...
{{< include exe/historique/40.qmd >}}

\newpage

{{< include exe/historique/50.qmd >}}

{{< include exe/historique/60.qmd >}}

\newpage

{{< include exe/historique/70.qmd >}}
