...
```{r, child=c('exe/introduction/12.Rmd')}
```
...
```{r, child=c('exe/introduction/15.Rmd')}
```
...
```{r, child=c('exe/introduction/35.Rmd')}
```
...
```{r, child=c('exe/introduction/120.Rmd')}
```

```{r, child=c('exe/introduction/140.Rmd')}
```

\newpage

```{r, child=c('exe/introduction/130.Rmd')}
```
