...
- Définir la constante d’acidité K~a~ et de basicité K~b~.
- Expliquer la notion d'autoprotolyse de l’eau et la relation entre |H~3~O^+^| et |OH^-^|.
...
- Définir une solution tampon et calculer son pH.
- Calculer les différents points d'une coubre de titrage.
