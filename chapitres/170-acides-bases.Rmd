...
$$
\ce{$\underset{\text{donneur de proton}}{\ce{HCl_{(aq)}}}$ + $\underset{\text{accepteur de proton}}{\ce{H2O_{(l)}}}$ -> H3O+ + Cl-}
$$

Aussi NH~3~ est une base puisqu'elle accepte un proton provenant de l'eau :

$$
\ce{$\underset{\text{accepteur de proton}}{\ce{NH3_{(aq)}}}$ + $\underset{\text{donneur de proton}}{\ce{H2O_{(l)}}}$ -> NH4+ + OH-}
$$
...
$$
\ce{NH4+_{(aq)} + OH^{-}_{(aq)} <=> NH_3_{(aq)} + H_2O_{(l)}}
$$
...
À nouveau, plus la constante est **petite**, plus l'équilibre est déplacé vers la **gauche** et donc plus la base est **faible**.
