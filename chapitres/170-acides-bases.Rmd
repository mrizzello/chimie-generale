...
|   ![](images/acides-forts-1.png){width=25%}    |   ![](images/bases-fortes-1.png){width=25%}   |
...
|:-----------------------------------------------:|:----------------------------------------------:|
| $\ce{HA(aq) + H2O(l) <=> H3O+(aq) + A^{-}(aq)}$ | $\ce{B(aq) + H2O(l) <=> BH+(aq) + OH^{-}(aq)}$ |
|   ![](images/acides-faibles-1.png){width=25%}   |   ![](images/bases-faibles-1.png){width=25%}   |
...
```{r acides-bases-3,echo=FALSE,out.width="80%",fig.show="hold",fig.align="center",fig.cap="Exemple de base faible azotée."}
