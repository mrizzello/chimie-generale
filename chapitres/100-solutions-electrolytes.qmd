...
```{r, child=c('exe/solutions-electrolytes/05.Rmd')}
```
...
```{r fig-ionique-moleculaire,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Dissolution de composés moléculaire et ionique"}
...
```{r, child=c('exe/solutions-electrolytes/25.Rmd')}
```
...
```{r fig-solubilite-saturation,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Solubilité et saturation"}
knitr::include_graphics(c("images/solution.png"))
```

```{r, child=c('exe/solutions-electrolytes/15.Rmd')}
```
...
```{r fig-dissociation,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Dissociation d'un composé ionique"}
...
```{r fig-conduction-solutions,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="Conduction électrique des solutions (eau pure, solution de NaCl, solution de saccharose)"}
...
```{r fig-electrolyte-2b,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Conductivité des solutions ioniques"}
...
```{r fig-dissociation-resume,echo=FALSE,out.width="100%",fig.show="hold",fig.align="center",fig.cap="Résumé dissolution-dissociation"}
...
```{r fig-fiole,echo=FALSE,out.width="20%",fig.show="hold",fig.align="center",fig.cap="Fioles jaugées"}
...
```{r fig-preparation-1,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Préparation d'une solution par dissolution"}
...
```{r fig-preparation-2,echo=FALSE,out.width="33%",fig.show="hold",fig.align="center",fig.cap="Préparation d'une solution par dilution"}
...
```{r, child=c('exe/solutions-electrolytes/100.Rmd')}
```

```{r, child=c('exe/solutions-electrolytes/110.Rmd')}
```

\newpage

```{r, child=c('exe/solutions-electrolytes/120.Rmd')}
```

```{r, child=c('exe/solutions-electrolytes/130.Rmd')}
```
