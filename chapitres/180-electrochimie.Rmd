...
Lorsque l'on observe un composé, il n’y a aucun transfert d’électrons; ceux-ci sont partagés. On peut cependant attribuer arbitrairement des nombres d’oxydation comme si les électrons étaient transférés. 
...
\ce{NO3^- + 1e^− -> NO2(g)} \quad \text{réduction}
\end{split}
$$
...
```{r electrolysis-potentials,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="Différences de potentiels redox."}
