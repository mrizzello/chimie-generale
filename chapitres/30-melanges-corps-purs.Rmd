...
![Corps purs et corps composés](images/corps-purs-corps-composes.png){width=67%}
...
![Résumé de la classification de la matière](images/schema-matiere.png){width=67%}
...
![Filtration par gravité](images/filtration.png){width=33%}
...
![Vaporisation](images/evaporation.png){width=33%}
...
![Dissolution sélective](images/dissolution-selective.png){width=100%}

### La sublimation

![Sublimation](images/sublimation.png){width=28%}
...
![Distillation simple](images/distillation.png){width=40%}
...
![Chromatographie sur colonne](images/chromatographie.png){width=67%}

\newpage

### L'extraction

![Extraction](images/extraction.png){width=50%}
...
![Sédimentation](images/sedimentation.png){width=40%}
