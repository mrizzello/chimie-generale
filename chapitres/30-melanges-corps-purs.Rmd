...
```{r evaporation,echo=FALSE,out.width="33%",fig.show="hold",fig.align="center",fig.cap="Vaporisation"}
...
```{r dissolution-selective,echo=FALSE,out.width="100%",fig.show="hold",fig.align="center",fig.cap="Dissolution sélective"}
...
```{r extraction,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Extraction"}
...
```{r sedimentation,echo=FALSE,out.width="40%",fig.show="hold",fig.align="center",fig.cap="Sédimentation"}
