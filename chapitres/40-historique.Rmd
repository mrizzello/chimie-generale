...
![Chronologie du cosmos](images/timeline-cosmos.png){width=80%}
...
![Schéma du tube cathodique de Thomson](images/exp-thomson.png){width=40%}
...
![Bombardement de la feuille d'or](images/exp-rutherford.png){width=40%}
...
![Comparaison des modèles de Thomson et de Rutherford](images/exp-thomson-rutherford.png){width=40%}
...
![Le modèle standard](images/modeles-atomiques-cloud.png){width=25%}
...
![Évolution du modèle atomique](images/modeles-atomiques-evol-3.png){width=75%}
...
![Tailles relatives approximatives en mètres](images/ordre-grandeur-ex.png){width=100%}
