...
```{r fig-corps-purs-corps-composes,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Corps purs et corps composés"}
knitr::include_graphics(c("images/corps-purs-corps-composes.png"))
```

```{r, child=c('exe/melanges-corps-purs/05.Rmd')}
```
...
```{r fig-schema-matiere,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Résumé de la classification de la matière"}
...
```{r fig-attraction-magnetique,echo=FALSE,out.width="38%",fig.show="hold",fig.align="center",fig.cap="Séparation par attraction magnétique"}
...
```{r fig-filtration,echo=FALSE,out.width="28%",fig.show="hold",fig.align="center",fig.cap="Filtration par gravité"}
...
```{r fig-evaporation,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="Vaporisation"}
...
```{r fig-dissolution-selective,echo=FALSE,out.width="85%",fig.show="hold",fig.align="center",fig.cap="Dissolution sélective"}
...
```{r fig-sublimation,echo=FALSE,out.width="28%",fig.show="hold",fig.align="center",fig.cap="Sublimation"}
...
```{r fig-distillation,echo=FALSE,out.width="40%",fig.show="hold",fig.align="center",fig.cap="Distillation simple"}
...
```{r fig-chromatographie,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Chromatographie sur colonne"}
...
```{r fig-extraction,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Extraction"}
...
```{r fig-sedimentation,echo=FALSE,out.width="33%",fig.show="hold",fig.align="center",fig.cap="Sédimentation"}
...
```{r, child=c('exe/melanges-corps-purs/70.Rmd')}
```

```{r, child=c('exe/melanges-corps-purs/80.Rmd')}
```

\newpage

```{r, child=c('exe/melanges-corps-purs/90.Rmd')}
```

```{r, child=c('exe/melanges-corps-purs/100.Rmd')}
```
