...
Table: (\#tab:spontaneite-dG) Spontanéité d'une réaction selon le signe de $\Delta G$.
...
Table: (\#tab:spontaneite-dG-K) Relation entre constante d'équilibre (K) et énergie libre standard de réaction ($\Delta G^o$).
