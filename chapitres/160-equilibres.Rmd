...
- On ne tient pas compte des substances à l'état solide et liquide dans l'expression de Q~r~ et de K~e~ (seuls les espèces dissoutes et les gaz).
...
Dit autrement : si on modifie les conditions d'un système en équilibre, il réagit de façon à s'opposer aux changements qu'on lui impose jusqu'à l'établissement d'un nouvel état d'équilibre.
...
$$
N_2\ _{(g)} + 3\ H_2(g)\ _{(g)} \leftrightharpoons 2\ NH_3\ _{(g)}
$$
...
```{r equilibres-temperature-1,echo=FALSE,out.width="75%",fig.show="hold",fig.align="center",fig.cap="Effet de la diminution du volume (augmentation de la pression) sur l'équilibre"}
