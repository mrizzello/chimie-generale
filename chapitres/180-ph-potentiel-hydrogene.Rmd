...
```{r acides-bases-6a,echo=FALSE,out.width="65%",fig.show="hold",fig.align="center",fig.cap="Neutralisation d'un acide fort par une base forte"}
...
```{r acides-bases-6b,echo=FALSE,out.width="65%",fig.show="hold",fig.align="center",fig.cap="Neutralisation d'une base forte par un acide fort"}
