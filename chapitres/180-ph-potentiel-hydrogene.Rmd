...
```{r acides-bases-5,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Titrage acide-base et courbe de titrage"}
...
Pour déterminer graphiquement le point d'équivalence sur une courbe de pH, la **méthode des tangentes** est utilisée. Elle consiste à tracer deux tangentes parallèles aux segments les plus abrupts de la courbe avant et après le saut de pH. La droite parallèle située à équidistance de ces deux tangentes coupe la courbe au point d'inflexion, qui correspond au point d'équivalence.
