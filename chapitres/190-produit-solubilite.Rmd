...
| $\ce{AB2 ->[H2O] 2A^+ + B^{2-}}$ | \|A^+^\| = 2s | \|B^-^\| = s | $K_{ps} = s \cdot (2s)^2 =4s^3$ |
| $\ce{AB3 ->[H2O] 3A^+ + B^{3-}}$ | \|A^+^\| = 3s | \|B^-^\| = s | $K_{ps} = s \cdot (3s)^3 = 27s^4$ |
| $\ce{A3B2 ->[H2O] 3A^{2+} + 2B^{3-}}$ | \|A^+^\| = 3s | \|B^-^\| = 2s | $K_{ps} = (3s)^3 \cdot (2s)^2 = 108s^5$ |
