...
```{r, child=c('exe/acides-bases/440.Rmd')}
```
...
```{r fig-acides-faibles-2,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Dissociation de l'acide carbonique."}
...
```{r fig-acides-bases-9,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Solution tampon acide acétique / acétate de sodium"}
...
```{r fig-acides-bases-8,echo=FALSE,out.width="95%",fig.show="hold",fig.align="center",fig.cap="Guide méthodologique pour la détermination du pH"}
...
```{r fig-acides-bases-5,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Titrage acide-base et courbe de titrage"}
...
```{r fig-acides-bases-6a,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Neutralisation d'un acide fort par une base forte"}
...
```{r, child=c('exe/acides-bases/450.Rmd')}
```
...
```{r fig-acides-bases-6b,echo=FALSE,out.width="60%",fig.show="hold",fig.align="center",fig.cap="Neutralisation d'une base forte par un acide fort"}
...
```{r fig-acides-bases-6c,echo=FALSE,out.width="65%",fig.show="hold",fig.align="center",fig.cap="Neutralisation d'un acide faible par une base forte"}
...
```{r, child=c('exe/acides-bases/470.Rmd')}
```
...
```{r fig-acides-bases-6d,echo=FALSE,out.width="65%",fig.show="hold",fig.align="center",fig.cap="Neutralisation d'une base faible par un acide fort"}
...
```{r fig-acides-bases-6e,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap=""}
...
```{r fig-acides-bases-7,echo=FALSE,out.width="75%",fig.show="hold",fig.align="center",fig.cap="Détermination graphique du point d'équivalence"}
...
```{r, child=c('exe/acides-bases/460.Rmd')}
```
...
```{r, child=c('exe/acides-bases/480.Rmd')}
```

```{r, child=c('exe/acides-bases/490.Rmd')}
```
