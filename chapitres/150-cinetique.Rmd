...
La théorie des collisions permet d’expliquer intuitivement que la vitesse d’une réaction dépend de la concentration (ou de la pression) et de la température. On peut dire de manière générale que **plus la fréquence des collisions entre réactifs est élevée, plus la vitesse de réaction est augmente**.
...
- Les catalyseurs homogènes - qui se trouve dans la même phase que les réactifs,
- les catalyseurs hétérogènes - qui se trouvent dans une phase différente que les réactifs,
- les catalyseurs enzymatiques - lorsque le catalyseur est une enzyme (biochimie),
- l'auto-catalyse - lorsqu'un des produits de la réaction est le catalyseur de la réaction.

\newpage

Dans le domaine de l'industrie, les exemples de catalyseurs sont très nombreux. Dans le domaine du vivant, on pourra citer :

- La levure qu'on ajoute au pain et qui catalyse de la levée du pain.
- Certaines plantes carnivores produisent des substances qui accélèrent leur digestion.
- Les réactions chimiques qui se déroulent dans le corps humain dépendent principalement de catalyseurs enzymatiques.
- Les zéolithes (aluminosilicates cristallins) pour leur réseau micro-poreux à l'intérieur duquel se déroulent certaines réactions catalytiques.
