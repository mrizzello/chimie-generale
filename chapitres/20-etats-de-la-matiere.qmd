...
```{r fig-Johnstone,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Les trois niveaux de représentation de la chimie"}
...
```{r fig-solide-liquide-gaz,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Les différents états de la matière du point de vue macroscopique et submicroscopique"}
...
```{r fig-mvt-thermique,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Équilibre entre forces intermoléculaires et énergie thermique"}
...
```{r, child=c('exe/etats-matiere/05.Rmd')}
```
...
```{r fig-chgt-etats,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Les noms des changements d'état"}
...
```{r fig-courbe-chgt-etat,echo=FALSE,out.width="40%",fig.show="hold",fig.align="center",fig.cap="Courbe de chauffage de l'eau"}
...
```{r, child=c('exe/etats-matiere/25.Rmd')}
```
...
```{r fig-diagramme-phases-eau-CO2,echo=FALSE,out.width="100%",fig.show="hold",fig.align="center",fig.cap="Diagramme de phases de l'eau et du CO~2~ (Les échelles ne sont pas régulières)"}
...
```{r fig-tension-surface,echo=FALSE,out.width="33%",fig.show="hold",fig.align="center",fig.cap="Tension superficielle"}
...
```{r fig-capillarity,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="La capillarité"}
knitr::include_graphics(c("images/capillarity.png"))
```

\newpage

```{r, child=c('exe/etats-matiere/32.Rmd')}
```
...
```{r fig-amorphous,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Solide amorphe (Verre) - Solide cristallin (Quartz)"}
...
```{r fig-metaux,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="3 mailles de réseaux cristallins classiques (CFC: cubique à face centrées, CC: cubique centré, HC: hexagonal compact)"}
...
```{r fig-allotropes,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Trois formes allotropiques du carbone (graphite, diamant, fullerène)"}
knitr::include_graphics(c("images/allotropes.png"))
```

```{r, child=c('exe/etats-matiere/34.Rmd')}
```
...
```{r, child=c('exe/etats-matiere/80.Rmd')}
```

\newpage

```{r, child=c('exe/etats-matiere/90.Rmd')}
```

```{r, child=c('exe/etats-matiere/100.Rmd')}
```
