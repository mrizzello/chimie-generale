...
![Une case du tableau périodique](images/tpe-case.png){width=67%}
...
- l’or, (6000 av. J.-C.)
- le cuivre, (4000 av. J.-C.)
- l’argent, (3500 av. J.-C.)
- le plomb, (3500 av. J.-C.)
- l’étain, (3000 av. J.-C.)
- le fer, (1500 av. J.-C.)
- le mercure, (750 av. J.-C.)
...
![Le vocabulaire du tableau périodique](images/tpe-empty.png){width=50%}
...
![Champs électrique (E) et magnétique (B) d'une onde électromagnétique. _crédit : wikimedia/SuperManu_](images/onde-electromagnetique.png){width=50%}
...
![Domaines du spectre électromagnétique. _crédit : wikimedia/Benjamin ABEL_](images/domaine-spectre-electromagnetique.png){width=95%}
...
![Différence entre spectres d'absorption et d'émission](images/absorption-emission.png){width=67%}
...
![Formes des orbitales s, p et d. _crédit : wikimedia/haade_](images/orb-3d.jpeg){width=67%}
...
![Diagramme énergétique des orbitales atomiques.](images/energy-level.png){width=25%}

### Déterminer une configuration électronique

![Ordre de remplissage des orbitales (#fig:energy-order)](images/energy-level-order.png){width=25%}
...
- La figure \@ref(fig:energy-order) donne l'ordre de remplissage des orbitales (principe Aufbau).
...
![Tableau périodique et diagramme des orbitales atomiques](images/energy-level-5.png){width=33%}

![Les orbitales atomiques dans le tableau périodique](images/tpe-orbitals.png){width=50%}
...
![Répartition électronique des trois premières périodes](images/configuration-electronique.png){width=75%}
