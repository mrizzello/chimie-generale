...
```{r onde-electromagnetique,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Champs électrique (E) et magnétique (B) d'une onde électromagnétique. crédit : wikimedia/SuperManu"}
...
```{r domaine-spectre-electromagnetique,echo=FALSE,out.width="95%",fig.show="hold",fig.align="center",fig.cap="Domaines du spectre électromagnétique. crédit : wikimedia/Benjamin ABEL"}
...
```{r orb-3d,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Formes des orbitales s, p et d. crédit : wikimedia/haade"}
