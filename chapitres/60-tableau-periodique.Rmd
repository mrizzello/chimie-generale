...
```{r tpe-empty,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Le vocabulaire du tableau périodique"}
...
```{r onde-electromagnetique,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Champs électrique (E) et magnétique (B) d'une onde électromagnétique. \_crédit : wikimedia/SuperManu\_"}
...
```{r domaine-spectre-electromagnetique,echo=FALSE,out.width="95%",fig.show="hold",fig.align="center",fig.cap="Domaines du spectre électromagnétique. \_crédit : wikimedia/Benjamin ABEL\_"}
...
```{r orb-3d,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Formes des orbitales s, p et d. \_crédit : wikimedia/haade\_"}
...
```{r configuration-electronique,echo=FALSE,out.width="75%",fig.show="hold",fig.align="center",fig.cap="Répartition électronique des trois premières périodes."}
