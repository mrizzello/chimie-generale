...
```{r courbe-chgt-etat,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="Courbe de chauffage de l'eau"}
...
```{r tension-surface,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="Tension superficielle"}
...
```{r capillarity,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="La capillarité"}
...
```{r metaux,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="3 mailles de réseaux cristallins classiques (CFC: cubique à face centrées, CC: cubique centré, HC: hexagonal compact)"}
