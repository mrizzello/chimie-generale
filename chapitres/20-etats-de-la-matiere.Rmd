...
![Solide amorphe (Verre) - Solide cristallin (Quartz)](images/amorphous.png){width=50%}
...
![3 mailles de réseaux cristallins classiques (CFC: cubique à face centrées, CC: cubique centré, HC: hexagonal compact)](images/metaux.png){width=55%}
...
![Trois formes allotropiques du carbone (graphite, diamant, fullerène)](images/allotropes.png){width=67%}
