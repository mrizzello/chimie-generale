...
![Corps purs et corps composés](images/corps-purs-corps-composes.png){#fig-corps-purs-corps-composes width="67%"}

{{< include exe/melanges-corps-purs/05.qmd >}}
...
![Résumé de la classification de la matière](images/schema-matiere.png){#fig-schema-matiere width="67%"}

{{< include exe/melanges-corps-purs/10.qmd >}}

\newpage

{{< include exe/melanges-corps-purs/20.qmd >}}
...
![Séparation par attraction magnétique](images/attraction-magnetique.png){#fig-attraction-magnetique width="38%"}
...
![Filtration par gravité](images/filtration.png){#fig-filtration width="28%"}
...
![Vaporisation](images/evaporation.png){#fig-evaporation width="25%"}
...
![Dissolution sélective](images/dissolution-selective.png){#fig-dissolution-selective width="85%"}
...
![Sublimation](images/sublimation.png){#fig-sublimation width="28%"}
...
![Distillation simple](images/distillation.png){#fig-distillation width="40%"}
...
![Chromatographie sur colonne](images/chromatographie.png){#fig-chromatographie width="67%"}
...
![Extraction](images/extraction.png){#fig-extraction width="45%"}
...
![Sédimentation](images/sedimentation.png){#fig-sedimentation width="33%"}
...
{{< include exe/melanges-corps-purs/30.qmd >}}
...
{{< include exe/melanges-corps-purs/60.qmd >}}

\newpage

{{< include exe/melanges-corps-purs/40.qmd >}}

{{< include exe/melanges-corps-purs/50.qmd >}}

\newpage

{{< include exe/melanges-corps-purs/70.qmd >}}

{{< include exe/melanges-corps-purs/80.qmd >}}

\newpage

{{< include exe/melanges-corps-purs/90.qmd >}}

{{< include exe/melanges-corps-purs/100.qmd >}}
