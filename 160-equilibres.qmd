...
::: {#fig-equilibres-concentrations-1 layout-ncol=2}
![](images/equilibres-concentrations-1a.png)

![](images/equilibres-concentrations-1b.png)

Profiles de la concentration en fonction du temps de la réaction directe et indirecte
:::
...
::: {#fig-equilibres-vitesses-1 layout-ncol=2}
![](images/equilibres-vitesses-1a.png)

![](images/equilibres-vitesses-1b.png)

Profiles de la vitesse de réaction en fonction du temps de la réaction directe et indirecte
:::
...
{{< include exe/equilibres/20.qmd >}}

{{< include exe/equilibres/25.qmd >}}
...
::: {#fig-equilibres-concentrations-2 layout-ncol=2}
![](images/equilibres-concentrations-2a.png)

![](images/equilibres-concentrations-2b.png)

Effet de l'ajout/élimination de réactifs ou de produits sur le sens de la réaction
:::
...
![Effet de la diminution du volume (augmentation de la pression) sur l'équilibre](images/equilibres-pressions-1.png){#fig-equilibres-pressions-1 width="75%"}
...
![Effet de l'ajout ou le retrait de chaleur sur l'équilibre](images/equilibres-temperature-1.png){#fig-equilibres-temperature-1 width="75%"}

### Quotient de réaction et évolution d'un système
...
{{< include exe/equilibres/30.qmd >}}

{{< include exe/equilibres/40.qmd >}}
...
{{< include exe/equilibres/80.qmd >}}

\newpage

{{< include exe/equilibres/50.qmd >}}

{{< include exe/equilibres/90.qmd >}}

\newpage

{{< include exe/equilibres/100.qmd >}}

{{< include exe/equilibres/110.qmd >}}

\newpage

{{< include exe/equilibres/120.qmd >}}
