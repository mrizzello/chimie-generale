...
![Schéma simplifié d'une pile Cu/Zn](images/pile-electrique-v2.png){#fig-pile-electrique-v2 width="90%"}
...
![Fonctionnement d’une pile Cu/Zn](images/pile-electrique.png){#fig-pile-electrique width="90%"}
\newpage
...
![Schéma de l'électrode standard à hydrogène.](images/ESH.png){#fig-ESH width="25%"}
...
{{< include exe/electrochimie/05.qmd >}}
...
{{< include exe/electrochimie/10.qmd >}}

{{< include exe/electrochimie/20.qmd >}}

{{< include exe/electrochimie/30.qmd >}}
...
![](images/nernst-illustration.png){width="50%"}
...
{{< include exe/electrochimie/50.qmd >}}
...
![Pile électrique et cellule électrolytique.](images/pile-recharge.png){#fig-pile-recharge width="67%"}
...
::: {#fig-electrolysis-water-NaCl layout-ncol=2}
![](images/electrolysis-water.png)

![](images/electrolysis-NaCl.png)

Schéma de l'électrolyse de l'eau pure et du chlorure de sodium fondu.
:::
...
![Schéma de l'électrolyse d'une solution de chlorure de sodium.](images/electrolysis-NaCl-sol.png){#fig-electrolysis-water-NaCl-sol width="65%"}
...
![Différences de potentiels oxred.](images/electrolysis-potentials.png){#fig-electrolysis-potentials width="25%"}
...
{{< include exe/electrochimie/60.qmd >}}
...
{{< include exe/electrochimie/40.qmd >}}
...
{{< include exe/electrochimie/70.qmd >}}

{{< include exe/electrochimie/80.qmd >}}
