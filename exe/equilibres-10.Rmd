...
1. $$ K_{c} = \frac{|N_2O| \cdot |NO_2|}{|NO|^{3}} \qquad \text{(homogène)} $$
2. $$ K_{c} = \frac{|CS_2| \cdot |H_2|^{4}}{|CH_4| \cdot |H_2S|^{2}} \qquad \text{(homogène)} $$
3. $$ K_{c} = \frac{|H^+| \cdot |F^-|}{|HF|} \qquad \text{(homogène)} $$
4. $$ K_{c} = |CO_2| \cdot |H_2O| = P_{CO_2} \cdot P_{H_2O} \qquad \text{(homogène)} $$
