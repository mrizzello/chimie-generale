...
{\centering \includegraphics[width=0.33\linewidth]{images/filtration} 
...
{\centering \includegraphics[width=0.5\linewidth]{images/tpe-empty} 
...
Les ondes qui vont nous intéresser dans le cadre de ce cours sont les \textbf{ondes électromagnétiques}. Une onde électromagnétique est une perturbation du champ électromagnétique qui se propage. Elle a la particularité de se propager aussi bien dans un milieu matériel que dans le vide. Les ondes radio, les ondes lumineuses ou les rayons X sont des exemples d'onde électromagnétique.

\begin{figure}

{\centering \includegraphics[width=0.67\linewidth]{images/onde-electromagnetique} 

}

\caption{Champs électrique (E) et magnétique (B) d'une onde électromagnétique.}\label{fig:onde-electromagnetique}
\end{figure}
...
Il s'avère que ces rayonnements permettent d'analyser des objets tels que les atomes et leurs électrons. L'analyse du rayonnement émis ou absorbé par la matière s'appelle la \textbf{spectroscopie}.
...
{\centering \includegraphics[width=0.67\linewidth]{images/absorption-emission} 
...
{\centering \includegraphics[width=0.67\linewidth]{images/orb-3d} 
...
{\centering \includegraphics[width=0.25\linewidth]{images/energy-level} 
...
La \textbf{configuration électronique} d'un atome est une notation abrégée de la répartition des électrons dans les différentes couches et sous-couches électroniques.
...
{\centering \includegraphics[width=0.33\linewidth]{images/energy-level-5} 

}

\caption{Tableau périodique et diagramme des orbitales atomiques.}\label{fig:energy-level-5}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{images/tpe-orbitals} 

}

\caption{Les orbitales atomiques dans le tableau périodique.}\label{fig:tpe-orbitals}
\end{figure}
...
\endhead
Hydrogène & ~ & ~ & ~ & ~ & ~ & ~ & Hélium \\
\includegraphics[width=\textwidth,height=4em]{images/1px.png} & ~ & ~ & ~ & ~ & ~ & ~ & \\
...
Ceci est dû au fait que leur couche électronique de valence est complètement remplie avec \textbf{huit électrons}, à l'exception de l'hélium, qui en a deux.
...
\endhead
Lithium & ~Béryllium & ~Bore & ~Carbone & Azote~ & ~Oxygène & ~Fluor & Néon \\
\includegraphics[width=\textwidth,height=3em]{images/1px.png} & ~ & ~ & ~ & ~ & ~ & ~ & \\
Sodium & Magnésium & Aluminium & Silicium & Phosphore & Soufre & Chlore & Argon \\
\includegraphics[width=\textwidth,height=3em]{images/1px.png} & ~ & ~ & ~ & ~ & ~ & ~ & \\
\bottomrule
\end{longtable}
...
\chapter{Les liaisons chimiques}\label{les-liaisons-chimiques}}
...
\section{La liaison covalente \textbar{} non-métal - non-métal}\label{la-liaison-covalente-non-muxe9tal---non-muxe9tal}}
...
\caption{Exemples de covalences de coordination ($SO$, $SO_2$, $SO_3$, $HClO$, $HClO_2$, $HClO_3$, $HClO_4$ ).}\label{fig:covalences-coordination}
\end{figure}

\hypertarget{la-liaison-ionique-muxe9tal---non-muxe9tal}{%
\section{La liaison ionique \textbar{} métal - non-métal}\label{la-liaison-ionique-muxe9tal---non-muxe9tal}}
...
{\centering \includegraphics[width=0.67\linewidth]{images/NaCl-diagram} 
...
{\centering \includegraphics[width=0.67\linewidth]{images/CaF2-diagram} 
...
\section{La liaison métallique \textbar{} métal - métal}\label{la-liaison-muxe9tallique-muxe9tal---muxe9tal}}
...
{\centering \includegraphics[width=0.2\linewidth]{images/metallic-bonding} 
...
\section{L'électronégativité}\label{luxe9lectronuxe9gativituxe9}}
...
\hypertarget{moluxe9cules}{%
\chapter{Molécules}\label{moluxe9cules}}
...
\section{La formule brute}\label{la-formule-brute}}
...
\section{La formule développée}\label{la-formule-duxe9veloppuxe9e}}
...
\subsection{Dessiner les liaisons ioniques des composés binaires}\label{dessiner-les-liaisons-ioniques-des-composuxe9s-binaires}}
...
\subsection{Dessiner les liaisons covalentes des composés binaires}\label{dessiner-les-liaisons-covalentes-des-composuxe9s-binaires}}
...
\begin{multicols}{2}
\includegraphics[width=0.4\textwidth,height=\textheight]{exe/formule-developpee.png}
...
\section{Les ions polyatomiques}\label{les-ions-polyatomiques}}

Les ions \(Na^+\), \(Mg^{2+}\) ou \(Cl^–\) sont \textbf{monoatomique}, ce qui signifie qu'ils sont constitué d'un seul atome ionisé. Il existe des ions \textbf{polyatomiques}, tels que \(NH4^+\) (ion ammonium) ou \(SO4^{2–}\) (ion sulfate). Ils se composent d'atomes liés par des covalences mais ils portent une charge positive ou négative.
...
\hypertarget{dessiner-les-composuxe9s-binaires-covalents-avec-un-atome-central}{%
\subsection{Dessiner les composés binaires covalents avec un atome central}\label{dessiner-les-composuxe9s-binaires-covalents-avec-un-atome-central}}
...
Une molécule de \(CH_4\) contient \ldots{}\\
- 1 atome de carbone et\\
- 4 atomes d'hydrogène.

Donc, une mole de molécules de \(CH_4\) contient \ldots{}\\
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.19}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.02}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.19}}@{}}
\toprule
\begin{minipage}[b]{\linewidth}\centering
\(CH_{4\ (g)}\)
...
\[
\frac{P_1 \cdot V_1}{n_1 \cdot T_1} = \frac{P_2 \cdot V_2}{n_2 \cdot T_2} \qquad \text{(loi générale des gaz)}
\]
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.51}}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.49}}@{}}
\toprule
\begin{minipage}[b]{\linewidth}\centering
ACIDE FORT
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\includegraphics[width=0.2\textwidth,height=\textheight]{images/acides-forts-1.png} & \includegraphics[width=0.2\textwidth,height=\textheight]{images/bases-fortes-1.png} \\
...
\endhead
\(\ce{HA(aq) + H2O(l) <=> H3O+(aq) + A^{-}(aq)}\) & \(\ce{B(aq) + H2O(l) <=> BH+(aq) + OH^{-}(aq)}\) \\
\includegraphics[width=0.2\textwidth,height=\textheight]{images/acides-faibles-1.png} & \includegraphics[width=0.2\textwidth,height=\textheight]{images/bases-faibles-1.png} \\
\bottomrule
\end{longtable}
...
\section{Le pH ou potentiel hydrogène}\label{le-ph-ou-potentiel-hydroguxe8ne}}
...
\subsection{pH des acides forts et des bases fortes}\label{ph-des-acides-forts-et-des-bases-fortes}}
...
\subsection{pH des acides faibles et des bases faibles}\label{ph-des-acides-faibles-et-des-bases-faibles}}
...
\subsubsection{Exemple d'un acide faible}\label{exemple-dun-acide-faible}}
...
\subsubsection{Exemple d'une base faible}\label{exemple-dune-base-faible}}
...
\subsection{pH des acides polyprotiques}\label{ph-des-acides-polyprotiques}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.09}}@{}}
