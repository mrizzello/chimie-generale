...
{\centering \includegraphics[width=0.65\linewidth]{images/courbes-titration-acide-fort} 
...
{\centering \includegraphics[width=0.65\linewidth]{images/courbes-titration-base-forte} 
...
\[
\Delta E = \Delta E^{0} - \frac{RT}{nF} \cdot \ln{Q} = \Delta E^{0} - \frac{RT}{nF} \cdot \ln{K_{e}}
\]
