...
Pour exprimer la spontanéité d'une transformation, nous introduisons une fonction thermodynamique appelée \textbf{énergie libre de Gibbs} (G) ou simplement \textbf{énergie libre}. L'énergie libre de Gibbs (G) d'un système est une mesure de la quantité d'énergie utilisable qui peut être fournie par ce système.
...
\item
  ...
  \[ S \Uparrow, \Delta S < 0 \]
\item
  L'eau s'évapore et se converti en gaz. \(S \Uparrow, \Delta S < 0\)\\
...
\midrule
\endhead
\(\ce{HCl(g)}\) & 186.8\tabularnewline
\(\ce{O2(g)}\) & 205.0\tabularnewline
\(\ce{Cl2(g)}\) & 223.0\tabularnewline
\(\ce{H2O(g)}\) & 188.7\tabularnewline
\bottomrule
\end{longtable}
