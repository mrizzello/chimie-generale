...
{{< include exe/types-reactions/10.qmd >}}
...
{{< include exe/types-reactions/20.qmd >}}
...
![Représentation moléculaire d'une réaction de précipitation](images/precipitation-0.png){#fig-precipitation-0 width="50%"}
...
{{< include exe/types-reactions/30.qmd >}}
...
{{< include exe/types-reactions/40.qmd >}}
...
{{< include exe/types-reactions/50.qmd >}}
...
![Echelle de pH](images/pH-echelle.png){#fig-pH-echelle width="90%"}

\newpage

{{< include exe/types-reactions/60.qmd >}}
...
Table: Indicateur acide-base. {#tbl-indicateur-acide-base}
...
{{< include exe/types-reactions/70.qmd >}}
...
{{< include exe/types-reactions/80.qmd >}}

{{< include exe/types-reactions/90.qmd >}}

{{< include exe/types-reactions/100.qmd >}}

\newpage

{{< include exe/types-reactions/110.qmd >}}

{{< include exe/types-reactions/120.qmd >}}

{{< include exe/types-reactions/130.qmd >}}

{{< include exe/types-reactions/140.qmd >}}

\newpage

{{< include exe/types-reactions/150.qmd >}}

{{< include exe/types-reactions/160.qmd >}}

{{< include exe/types-reactions/170.qmd >}}

\newpage

{{< include exe/types-reactions/180.qmd >}}

{{< include exe/types-reactions/190.qmd >}}

{{< include exe/types-reactions/200.qmd >}}

\newpage

{{< include exe/types-reactions/210.qmd >}}
