...
Table: Exemples de nombres d'oxydation. {#tbl-tab-NO-examples}
...
Table: Règles pour l'attribution des nombres d'oxydation. {#tbl-tab-NO-rules}
...
{{< include exe/oxydoreductions/10.qmd >}}
...
{{< include exe/oxydoreductions/20.qmd >}}
...
Table: Résumé des termes liés à l'oxydoréduction. {#tbl-tab-NO-summary}
...
{{< include exe/oxydoreductions/70.qmd >}}

{{< include exe/oxydoreductions/30.qmd >}}
...
\underset{\text{oxydant 1}}{2\ce{Ag}^{+}} + \underset{\text{réducteur 2}}{\ce{Cu}} &\ce{->}
\underset{\text{réducteur 1}}{2\ce{Ag}} + \underset{\text{oxydant 2}}{\ce{Cu}^{2+}}
\end{split}
$$
...
![Illustration de la règle du gamma.](images/gamma-rule.png){#fig-gamma-rule width="45%"}
...
{{< include exe/oxydoreductions/35.qmd >}}
...
$$
\begin{aligned}
\ce{\overset{0}{Sn}} & \ce{-> \overset{+4}{Sn} + 4e^−} &\quad (\times 1) &\quad \text{oxydation} \\
\ce{\overset{+5}{N} + 1e^−} & \ce{-> \overset{+4}{N}} &\quad (\times 4) &\quad \text{réduction}
\end{aligned}
$$
...
{{< include exe/oxydoreductions/40.qmd >}}

\newpage

{{< include exe/oxydoreductions/80.qmd >}}

{{< include exe/oxydoreductions/90.qmd >}}

{{< include exe/oxydoreductions/100.qmd >}}
...
{{< include exe/oxydoreductions/50.qmd >}}

{{< include exe/oxydoreductions/60.qmd >}}

\newpage

{{< include exe/oxydoreductions/110.qmd >}}

{{< include exe/oxydoreductions/120.qmd >}}

{{< include exe/oxydoreductions/130.qmd >}}

{{< include exe/oxydoreductions/150.qmd >}}

\newpage

{{< include exe/oxydoreductions/160.qmd >}}

{{< include exe/oxydoreductions/170.qmd >}}
