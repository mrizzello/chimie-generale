...
![Une case du tableau périodique](images/tpe-case.png){#fig-tpe-case width="67%"}
...
![Le vocabulaire du tableau périodique](images/tpe-empty.png){#fig-tpe-empty width="45%"}

\newpage

{{< include exe/tableau-periodique/05.qmd >}}
...
![Longueur d'onde, fréquence et énergie](images/ondes-electromagnetiques.png){#fig-ondes-electromagnetiques width="75%"}
...
\qquad
\begin{split}
E & \text{ : énergie du photon, en } \text{ J} \\
h & \text{ : constante de Planck, } 6.625 \cdot 10^{-34}\ \text{ J}\cdot\text{s} \\
\nu & \text{ : fréquence, en } \text{ Hz} \\
\lambda & \text{ : longueur d'onde, en } \text{ m} \\
c & \text{ : vitesse de la lumière, } 3 \cdot 10^{8}\ \text{ m}\cdot\text{s}^{-1}
\end{split}
$$

{{< include exe/tableau-periodique/12.qmd >}}
...
![Domaines du spectre électromagnétique.](images/domaine-spectre-electromagnetique.png){#fig-domaine-spectre-electromagnetique width="95%"}
...
Table: Domaine du spectre visible. {#tbl-domaine-spectre-visible}
...
![Différence entre spectres d'absorption et d'émission](images/absorption-emission.png){#fig-absorption-emission width="50%"}
...
{{< include exe/tableau-periodique/15.qmd >}}
...
Table: Résumé des couches, sous-couches et orbitales. {#tbl-couches-sous-couches-orbitales}
...
![Formes des orbitales s, p et d.](images/orb-3d.jpeg){#fig-orb-3d width="90%"}
...
![Diagramme énergétique des orbitales atomiques.](images/energy-level.png){#fig-energy-level width="40%"}

### Déterminer une configuration électronique

![Ordre de remplissage des orbitales.](images/energy-level-order.png){#fig-energy-level-order width="25%"}
...
- La @fig-energy-level-order donne l'ordre de remplissage des orbitales (principe Aufbau).
...
{{< include exe/tableau-periodique/10.qmd >}}
...
Table: Configuration électronique des deux premières périodes. {#tbl-conf-elec-premieres-periodes}

{{< include exe/tableau-periodique/18.qmd >}}
...
::: {#fig-energy-level-5 layout-ncol=2}
![](images/energy-level-5.png)

![](images/tpe-orbitals.png)

Les orbitales atomiques et le tableau périodique.
:::
...
![Répartition électronique des trois premières périodes.](images/configuration-electronique.png){#fig-configuration-electronique width="100%"}

{{< include exe/tableau-periodique/25.qmd >}}
...
Table: Structure de Lewis des éléments du groupe principal (c = célibataire, p = paire). {#tbl-structure-lewis-groupe-principal}

{{< include exe/tableau-periodique/20.qmd >}}

::: {.Jeu data-latex=""}

**Jeu en ligne** — Entraînez-vous à trouver la bonne structure de Lewis à partir des informations fournies sur [isotope.ch/lewis](https://isotope.ch/lewis).
...
{{< include exe/tableau-periodique/30.qmd >}}
...
{{< include exe/tableau-periodique/40.qmd >}}
...
{{< include exe/tableau-periodique/50.qmd >}}

\newpage

{{< include exe/tableau-periodique/60.qmd >}}

{{< include exe/tableau-periodique/70.qmd >}}

{{< include exe/tableau-periodique/80.qmd >}}

{{< include exe/tableau-periodique/90.qmd >}}
\newpage

{{< include exe/tableau-periodique/100.qmd >}}

{{< include exe/tableau-periodique/110.qmd >}}

\newpage

{{< include exe/tableau-periodique/120.qmd >}}

{{< include exe/tableau-periodique/130.qmd >}}

\newpage

{{< include exe/tableau-periodique/140.qmd >}}
