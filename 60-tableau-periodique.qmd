...
```{r fig-tpe-case,echo=FALSE,out.width="67%",fig.show="hold",fig.align="center",fig.cap="Une case du tableau périodique"}
...
```{r fig-tpe-empty,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Le vocabulaire du tableau périodique"}
knitr::include_graphics(c("images/tpe-empty.png"))
```

\newpage

```{r, child=c('exe/tableau-periodique/05.Rmd')}
```
...
```{r, child=c('exe/tableau-periodique/08.Rmd')}
```
...
```{r fig-ondes-electromagnetiques,echo=FALSE,out.width="75%",fig.show="hold",fig.align="center",fig.cap="Longueur d'onde, fréquence et énergie"}
...
```{r, child=c('exe/tableau-periodique/12.Rmd')}
```
...
```{r fig-domaine-spectre-electromagnetique,echo=FALSE,out.width="95%",fig.show="hold",fig.align="center",fig.cap="Domaines du spectre électromagnétique."}
...
```{r fig-absorption-emission,echo=FALSE,out.width="50%",fig.show="hold",fig.align="center",fig.cap="Différence entre spectres d'absorption et d'émission"}
...
```{r, child=c('exe/tableau-periodique/15.Rmd')}
```
...
```{r fig-orb-3d,echo=FALSE,out.width="90%",fig.show="hold",fig.align="center",fig.cap="Formes des orbitales s, p et d."}
...
```{r fig-energy-level,echo=FALSE,out.width="40%",fig.show="hold",fig.align="center",fig.cap="Diagramme énergétique des orbitales atomiques."}
knitr::include_graphics(c("images/energy-level.png"))
```

### Déterminer une configuration électronique

```{r fig-energy-level-order,echo=FALSE,out.width="25%",fig.show="hold",fig.align="center",fig.cap="Ordre de remplissage des orbitales."}
...
- La figure @fig-energy-level-order donne l'ordre de remplissage des orbitales (principe Aufbau).
...
```{r, child=c('exe/tableau-periodique/18.Rmd')}
```
...
```{r fig-energy-level-5,echo=FALSE,out.width="45%",fig.show="hold",fig.align="center",fig.cap="Les orbitales atomiques et le tableau périodique."}
#| layout-ncol: 2
...
```{r fig-configuration-electronique,echo=FALSE,out.width="100%",fig.show="hold",fig.align="center",fig.cap="Répartition électronique des trois premières périodes."}
knitr::include_graphics(c("images/configuration-electronique.png"))
```

```{r, child=c('exe/tableau-periodique/25.Rmd')}
```
...
```{r, child=c('exe/tableau-periodique/110.Rmd')}
```

\newpage

```{r, child=c('exe/tableau-periodique/120.Rmd')}
```

```{r, child=c('exe/tableau-periodique/130.Rmd')}
```

\newpage

```{r, child=c('exe/tableau-periodique/140.Rmd')}
```
